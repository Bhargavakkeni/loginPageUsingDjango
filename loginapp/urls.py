...
urlpatterns=[
    ...
    path('loginpage/verifyUser',views.verifyUser,name='verifyUser'), #url for verification
    ...
    path('omsadmin',views.omsadmin,name='omsadmin'), #url for displaying a dummy template when login is successful
]